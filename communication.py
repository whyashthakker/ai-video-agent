...
def send_email(email, video_url):
    try:
        ...
        <html>
            <body>
                <h2>🎉 Your AI Generated Short is Ready! 🎉 (Expires in 1 Day)</h2>
                
                <p>Thank you for using Snapy! Your AI Generated Short has been processed successfully. You can:</p>
                
                <ul>
                    <li><a href="{video_url}">Download your video</a></li>
                    <li>Check the job status and download from your <a href="https://app.snapy.ai/ai-shorts-generator">dashboard</a></li>
                    <li>Want to process another video? <a href="https://app.snapy.ai/ai-shorts-generator">Upload another video</a></li>
                </ul>
